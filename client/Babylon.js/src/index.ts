...
class DMeshScene
{
    ...
    private update = (): void => {
        ...
        // if (this.importOn) {
        //     this.objectManager.anim_import(this.strategyManager.executeStrategy);    // from Museum application
        // }
    ...
    //     switch(this.strategyManager.getChosenStrategy()) {
    //         case ChooseStrategy.Naive_1: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Greedy_1);
    //             textB.text = "Strategy : \nGreedy1";
    //         break
    //         case ChooseStrategy.Greedy_1: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Proposed_1);
    //             textB.text = "Strategy : \nProposed1";
    //         break
    //         case ChooseStrategy.Proposed_1: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Greedy_2);
    //             textB.text = "Strategy : \nGreedy2";
    //         break
    //         case ChooseStrategy.Greedy_2: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Uniform_2);
    //             textB.text = "Strategy : \nUniform2";
    //         break
    //         case ChooseStrategy.Uniform_2: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Hybrid_2);
    //             textB.text = "Strategy : \nHybrid2";
    //         break
    //         case ChooseStrategy.Hybrid_2: 
    //             this.strategyManager.setStrategy(ChooseStrategy.Moq_1);
    //             textB.text = "Strategy : \nMoq1";
    //         break
    //         case ChooseStrategy.Moq_1:
    //             this.strategyManager.setStrategy(ChooseStrategy.Naive_1);
    //             textB.text = "Strategy : \nNaive1"
    //         break
    //     }
    // }
